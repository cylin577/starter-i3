...
[ -f "./autostart.sh" ] && check_source_exists "./autostart.sh" && mkdir -p "$HOME/.config/i3" && install -m 755 ./autostart.sh "$HOME/.config/i3/autostart.sh" 2>/dev/null || { cp -v ./autostart.sh "$HOME/.config/i3/autostart.sh"; chmod 755 "$HOME/.config/i3/autostart.sh"; }
